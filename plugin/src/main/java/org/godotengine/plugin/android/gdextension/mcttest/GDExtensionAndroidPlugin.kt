...
package org.godotengine.plugin.android.gdextension.mcttest
...
class MCTTestGDExtension(godot: Godot): GodotPlugin(godot) {

    companion object {
        val TAG = MCTTestGDExtension::class.java.simpleName
